...
my_image = PhotoImage(file='C:\\Users\\DELL\Desktop\\semister project\\abc.png')
...
label.place(relwidth=0.999,relheight=1)

my_image2 = PhotoImage(file='C:\\Users\\DELL\Desktop\\semister project\\ert2.png')
my_label = Label(lower_frame,image=my_image2)
my_label.place(relx=0.01,rely=0.01)
...
def LoginForm():
    ...
    lbl_text = Label(TopLoginForm, text="Administrator Login",bg="#80c1ff", font=('arial', 18), width=600)
    ...
    btn_login = Button(MidLoginForm, text="Login", font=('arial', 18), width=30,bg="#80c1ff" ,command=Login)
...
def Home():
    ...
    Title.pack(pady=10)
    lbl_display = Label(Title, text="Inventory management system ", font=('arial', 40))
    lbl_display.pack()
    menubar = Menu(Home)
...
def AddNewForm():
    TopAddNew = Frame(addnewform, width=600, height=100, bd=1, relief=SOLID,bg='blue')
...
def ViewForm():
    global tree
    TopViewForm = Frame(viewform, width=600, bd=1, relief=SOLID, bg='blue')
